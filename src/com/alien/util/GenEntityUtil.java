...
public class GenEntityUtil {
	...
	public GenEntityUtil(String tablename) throws SQLException {
		 DBConn dbconn = new DBConn();
		Connection conn = dbconn.getConn();// 得到数据库连接
		String strsql = "select * from t_"+tablename;
		try {
			...
			try {
				FileWriter fw = new FileWriter(PathUtil.getCurrentPath()+"entity/"+initcap(tablename) + ".java");
	...
	private String parse(String[] colNames, String[] colTypes, int[] colSizes,String tablename) {
		...
		sb.append("package com.alien.entity;\r\n\r\n\r\n");
		if (f_util) {
