...
import com.alien.config.Setting.WatermarkPosition;
...
public class ImageUtil {
	...
	public static String copyImageFile(ServletContext servletContext, File imageFile) {
		return copyImageFile(servletContext, imageFile,null);		
	}
	/**
	 * 复制图片文件至图片目录
	 * @param imageFile 图片文件
	 * @return 图片文件路径    
	 */
	public static String copyImageFile(ServletContext servletContext, File imageFile,String uploadRealPath) {
		if (imageFile == null) {
			return null;
		}
		...
		String destImagePath = (StringUtils.isEmpty(uploadRealPath)?SettingUtil.getSetting().getImageUploadRealPath():uploadRealPath) + "/" + CommonUtil.getUUID() + "." + formatName;
