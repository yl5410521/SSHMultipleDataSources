...
public class GenServiceUtil {
	...
	public GenServiceUtil(String tablename) throws SQLException {
	tablename=tablename.substring(0, 1).toUpperCase()
			+ tablename.substring(1);
			String content = parse(tablename);
			try {
				FileWriter fw = new FileWriter(PathUtil.getCurrentPath()+"service/"+initcap(tablename) + "Service.java");
	...
	private String parse(String tablename) {
		...
		sb.append("package com.alien.service;\r\n\r\n\r\n");
		if (f_util) {
		...
		sb.append("public interface " + initcap(tablename) + "Service extends BaseService<"+tablename+", String> {\r\n");
		sb.append("}\r\n");
