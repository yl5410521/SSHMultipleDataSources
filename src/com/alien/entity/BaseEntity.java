...
public class BaseEntity implements Serializable {
	...
	public static final String CREATE_DATE_PROPERTY_NAME = "createDate";// "创建日期"属�?名称
	public static final String MODIFY_DATE_PROPERTY_NAME = "modifyDate";// "修改日期"属�?名称
	...
	@GenericGenerator(name = "uuid", strategy = "com.alien.util.T8UUIDGenerator") 
	public String getId() {  
		return id;
	}
